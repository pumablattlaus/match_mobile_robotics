...
class LissajousResponsePublisher:
    ...
    def config(self):
        self.a = rospy.get_param("~a", 0.12)
        self.b = rospy.get_param("~b", 0.12)
        self.c = rospy.get_param("~c", 0.16)
    ...
    def run(self):
        ...
        for i in range(0,len(self.path_out.poses)-1):
            ...
            self.cmd.angular.x = dx / sleep_dur * 1.8
            self.cmd.angular.y = dy / sleep_dur * 1.8
            self.cmd.angular.z = dz / sleep_dur * 0.5
